...
ent_field.grid(row=0, columnspan=4, padx=10, pady=10, sticky="n" + "s" + "e" + "w")
...
btn_CE = tk.Button(
    root,
    text="CE",
    command=lambda: sc_app.Clear_Entry(),
    font=FONT,
    height=2,
    fg="#000000",
...
btn_CE.grid(
    row=1, column=0, columnspan=3, sticky="n" + "s" + "e" + "w", padx=10, pady=10
)

btn_equal = tk.Button(
    root,
    text="=",
    command=lambda: sc_app.Standard_Ops("="),
    font=FONT,
    width=6,
    height=2,
    fg="#000000",
...
btn_0 = tk.Button(
    root,
    text="0",
    command=lambda: sc_app.Enter_Num("0"),
    font=FONT,
    width=6,
    height=2,
    fg="#000000",
...
btn_0.grid(
    row=5, column=1, columnspan=2, sticky="n" + "s" + "e" + "w", padx=10, pady=10
)
...
btn_point.grid(row=5, column=0, sticky="n" + "s" + "e" + "w", padx=10, pady=10)
